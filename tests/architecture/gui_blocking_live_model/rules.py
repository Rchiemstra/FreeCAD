...
REVIEWED_TRANSITIVE_IMPORT_EXCLUSIONS: dict[str, str] = {
    "src/Mod/BIM/ArchCovering.py": "BIM model helper; GUI caller is inventoried",
    "src/Mod/BIM/ArchVRM.py": "BIM model helper; GUI caller is inventoried",
    "src/Mod/BIM/importers/exportIFCHelper.py": "BIM IFC helper; GUI caller is inventoried",
    "src/Mod/BIM/importers/importIFCmulticore.py": "BIM IFC helper; GUI caller is inventoried",
    "src/Mod/CAM/Path/Op/SurfaceSupport.py": "CAM geometry helper; GUI caller is inventoried",
    "src/Mod/CAM/Path/Post/UtilsExport.py": "CAM export helper; GUI caller is inventoried",
    ...
    "src/Mod/Draft/draftfunctions/cut.py": "Draft geometry constructor; no GUI handlers",
    "src/Mod/Draft/draftfunctions/downgrade.py": "Draft geometry constructor; no GUI handlers",
    "src/Mod/Draft/draftfunctions/draftify.py": "Draft geometry constructor; no GUI handlers",
    "src/Mod/Draft/draftfunctions/extrude.py": "Draft geometry constructor; no GUI handlers",
    "src/Mod/Draft/draftfunctions/fuse.py": "Draft geometry constructor; no GUI handlers",
    "src/Mod/Draft/draftfunctions/heal.py": "Draft geometry constructor; no GUI handlers",
    "src/Mod/Draft/draftfunctions/join.py": "Draft geometry constructor; no GUI handlers",
    "src/Mod/Draft/draftfunctions/offset.py": "Draft geometry constructor; no GUI handlers",
    "src/Mod/Draft/draftfunctions/upgrade.py": "Draft geometry constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_arc_3points.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_array.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_bezcurve.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_block.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_bspline.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_circle.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_circulararray.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_copy.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_dimension.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_ellipse.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_facebinder.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_layer.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_orthoarray.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_patharray.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_pointarray.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_polararray.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_polygon.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_rectangle.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_shape2dview.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_shapestring.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_sketch.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_text.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_wire.py": "Draft model constructor; no GUI handlers",
    "src/Mod/Draft/draftmake/make_wpproxy.py": "Draft model constructor; no GUI handlers",
    ...
    "src/Mod/Fem/femresult/resulttools.py": "FEM result helper; GUI caller is inventoried",
    "src/Mod/Fem/femsolver/mystran/tasks.py": "FEM solver task helper; GUI caller is inventoried",
    "src/Mod/OpenSCAD/OpenSCAD2Dgeom.py": "OpenSCAD geometry importer; GUI caller is inventoried",
