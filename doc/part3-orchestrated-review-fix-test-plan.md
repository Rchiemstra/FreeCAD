...
Checked 2026-08-17: parent WP08 this SHA pushed to `origin/fix/change-aware-save-mcp-autonomy`; nested `71a89c70` unchanged; gitlink `71a89c70`. P3-WP00..WP08 **Done**. Next: STOP. Do not start WP09. Composer idle.
...
| P3-WP08 — Windows lock anchor | Done | Gate PASS. Parent `this SHA` exports `DocumentFileLock` and probe `FREECAD_DOCUMENTFILEWRITER_TEST_API` (Windows+Linux 24/24). Nested not committed. Gitlink held at `71a89c70`. Composer idle. Do not start WP09. |
