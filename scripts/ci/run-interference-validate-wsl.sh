...
/usr/bin/xvfb-run -a /data/build/tests/AssemblyGui_tests_run \
  --gtest_filter=TaskInterferenceCheckTest.bThenALateFinishDoesNotMutateNewerUiState:TaskInterferenceCheckTest.obsoleteFaceResultDoesNotReplaceGoverningPreview:TaskInterferenceCheckTest.placedLeafPreviewRestoresWorldTransform:TaskInterferenceCheckTest.tableAndPreviewUseTheSameGoverningFaceHit:TaskInterferenceCheckTest.governingContactCommonShapeDrivesPreview:TaskInterferenceCheckTest.inconclusiveFaceWithoutGeometryCreatesNoOriginMarker:TaskInterferenceCheckTest.documentCloseDiscardsResultsAndClosesManageExclusions:TaskInterferenceCheckTest.linkedDocumentCloseMarksResultsStaleAndClosesManageExclusions \
