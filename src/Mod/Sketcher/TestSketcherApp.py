...
from SketcherTests.TestSketchDeltaPosition import TestSketchDeltaPosition
...
from SketcherTests.TestSketchMalformedConstraints import TestSketchMalformedConstraints
