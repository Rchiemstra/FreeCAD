...
std::string ReviewNotePy::representation() const
{
    return {"<Review Note>"};
}

PyObject* ReviewNotePy::refreshBasePosition(PyObject* args)
{
    if (!PyArg_ParseTuple(args, "")) {
        return nullptr;
    }
    getReviewNotePtr()->refreshBasePosition();
    Py_Return;
}

PyObject* ReviewNotePy::isAttachmentBroken(PyObject* args) const
{
    if (!PyArg_ParseTuple(args, "")) {
        return nullptr;
    }
...
int ReviewNotePy::setCustomAttributes(const char* /*attr*/, PyObject* /*obj*/)
{
    return 0;
}
